...
export const SEASON_WEEK_COUNT = 52;
export const PLE_CYCLE_WEEKS = 4;
...
export const DRAFT_CONTRACT_WEEKS = SEASON_WEEK_COUNT;
export const MARKET_CONTRACT_MAX_WEEKS = SEASON_WEEK_COUNT;
