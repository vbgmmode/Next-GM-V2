...
export const rivalryStorylineCatalog: RivalryStorylineEntry[] = [
  ...
  },
  {
    id: "betrayal",
    name: "Betrayal",
    description: "A partner, ally, or trusted peer turns a relationship into a personal feud.",
    participantStructure: "1v1/tag",
    divisionFit: "All",
    titleFit: "Mostly non-title",
    commonBeats: "Fake apology, ambush, tag-team fracture, heated promo, final grudge match",
    recommendedBlowoffMatches: "Street Fight, Steel Cage, Last Man Standing",
    relationshipTag: "rivals",
    bookingNotes: "Best when the participants already share TV time or affiliation context",
  },
  {
    id: "unfinished_business",
    name: "Unfinished Business",
    description: "A prior result, unresolved ending, or messy payoff keeps two sides locked together.",
    participantStructure: "1v1/tag",
    divisionFit: "All",
    titleFit: "Non-title or title",
    commonBeats: "Replay argument, rematch demand, disputed finish, stipulation added",
    recommendedBlowoffMatches: "No DQ, Iron Man, Steel Cage",
    relationshipTag: "rivals",
    bookingNotes: "Use when a rematch needs a reason beyond repetition",
  },
  {
    id: "stolen_opportunity",
    name: "Stolen Opportunity",
    description: "One wrestler believes a rival took their title shot, spotlight, or career moment.",
    participantStructure: "1v1",
    divisionFit: "All",
    titleFit: "Title-adjacent",
    commonBeats: "Contender dispute, interference accusation, contract signing, decisive match",
    recommendedBlowoffMatches: "Ladder, No DQ, Standard Singles",
    relationshipTag: "rivals",
    bookingNotes: "Strong for title scenes without forcing every beat to be a title match",
  },
  {
    id: "contender_collision",
    name: "Contender Collision",
    description: "Two credible contenders crash into each other while chasing the same lane.",
    participantStructure: "1v1/tag",
    divisionFit: "Top/Middle/Tag/Women",
    titleFit: "Contender or title",
    commonBeats: "Contender match, scouting promo, champion watches, final eliminator",
    recommendedBlowoffMatches: "Standard Singles, Submission, Ladder",
    relationshipTag: "competitive_rivals",
    bookingNotes: "Keeps stakes clear without needing deep hatred",
  },
  {
    id: "power_struggle",
    name: "Power Struggle",
    description: "Two stars fight over leadership, control, or who sets the tone for the brand.",
    participantStructure: "1v1 or multi",
    divisionFit: "All",
    titleFit: "Non-title or title",
    commonBeats: "Locker-room claim, interruption, alliance pressure, authority challenge",
    recommendedBlowoffMatches: "Steel Cage, Last Man Standing, No DQ",
    relationshipTag: "rivals",
    bookingNotes: "Works best with high-popularity wrestlers or faction-adjacent casts",
  },
  {
    id: "prove_yourself",
    name: "Prove Yourself",
    description: "A wrestler has to prove they belong against a more established name.",
    participantStructure: "1v1",
    divisionFit: "All",
    titleFit: "Non-title or contender",
    commonBeats: "Gatekeeper test, close loss, respect tease, decisive win",
    recommendedBlowoffMatches: "Standard Singles, Submission, Iron Man",
    relationshipTag: "respect_or_rivals",
    bookingNotes: "Good for building a prospect without inventing hidden story",
  },
  {
    id: "mentor_student_break",
    name: "Mentor/Student Break",
    description: "A teacher-student or veteran-protege dynamic cracks under pressure.",
    participantStructure: "1v1/tag",
    divisionFit: "All",
    titleFit: "Mostly non-title",
    commonBeats: "Lesson match, rejection promo, cheap shot, respect or betrayal finish",
    recommendedBlowoffMatches: "Submission, 2 out of 3 Falls, Street Fight",
    relationshipTag: "respect_or_rivals",
    bookingNotes: "Can resolve as respect or become a full grudge",
  },
  {
    id: "tag_team_tension",
    name: "Tag Team Tension",
    description: "A tag team or pair starts breaking down under pressure.",
    participantStructure: "tag or 1v1",
    divisionFit: "Tag/All",
    titleFit: "Tag or non-title",
    commonBeats: "Miscommunication, apology tease, partner walks out, final split",
    recommendedBlowoffMatches: "Tag Team Match, Street Fight, Steel Cage",
    relationshipTag: "rivals",
    bookingNotes: "Do not add team records; use the existing participants and affiliation context only",
  },
  {
    id: "faction_war",
    name: "Faction War",
    description: "Groups, allies, or loose factions collide over territory and momentum.",
    participantStructure: "tag/multi",
    divisionFit: "All",
    titleFit: "Non-title or title-adjacent",
    commonBeats: "Backstage confrontation, tag preview, numbers game, multi-person payoff",
    recommendedBlowoffMatches: "Tag Team Match, Steel Cage, TLC",
    relationshipTag: "rivals",
    bookingNotes: "Use multi-person rivalry structure without creating team-level stats",
  },
  {
    id: "title_obsession",
    name: "Title Obsession",
    description: "A challenger or champion lets championship pressure turn into a personal fixation.",
    participantStructure: "1v1/tag",
    divisionFit: "Title divisions",
    titleFit: "Title",
    commonBeats: "Belt stare, cheap shot, contract signing, stipulation title match",
    recommendedBlowoffMatches: "Ladder, Steel Cage, Iron Man",
    relationshipTag: "rivals",
    bookingNotes: "Best for a title story that should feel more heated than procedural",
  },
  {
    id: "career_crossroads",
    name: "Career Crossroads",
    description: "A veteran, prospect, or cooling star needs a defining win to redirect their season.",
    participantStructure: "1v1",
    divisionFit: "All",
    titleFit: "Non-title or contender",
    commonBeats: "Desperation promo, prove-it match, near miss, decisive reset",
    recommendedBlowoffMatches: "Standard Singles, Last Man Standing, Submission",
    relationshipTag: "redemption",
    bookingNotes: "Good when one participant needs a clear reason to matter again",
  },
  {
    id: "respect_feud",
    name: "Respect Feud",
...
export const safeRivalryStorylineOptions = rivalryStorylineCatalog.filter((storyline) => {
  const participantStructure = storyline.participantStructure.toLowerCase();
  return !participantStructure.includes("3") && !participantStructure.includes("multi");
});
