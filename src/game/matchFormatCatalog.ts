...
export const segmentCatalogOptions: SegmentCatalogOption[] = [
  ...
  },
  {
    ...
    note: "Four wrestlers required. The first two are Team A, the last two are Team B. Tag title eligible only when the champions are together on one side.",
  ...
  },
  {
    ...
    note: "Three wrestlers required. Singles titles are eligible when the champion is involved and every participant fits the title division.",
  ...
  },
  {
    ...
    note: "Four wrestlers required. Singles titles are eligible when the champion is involved and every participant fits the title division.",
