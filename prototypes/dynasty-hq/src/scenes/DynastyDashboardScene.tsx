...
type Props = {
  game: GameState;
  result?: ShowResult;
  onNavigateStub: (screen: GameScreen) => void;
};
...
export function DynastyDashboardScene({ game, result, onNavigateStub }: Props) {
  ...
  return (
    <main className={`game-dashboard-shell dynasty-hq-shell ${themeClass}`}>
      ...
      <div className="dynasty-nav-bridge">
        <GameNav
          ...
          hasWeekReview={model.hasWeekReview}
          onNavigate={onNavigateStub}
        />
      </div>
      ...
      <section className="dashboard-main-grid">
            ...
            <article className="panel promo-panel">
              <div className="promo-backdrop dynasty-promo-backdrop">
                ...
                <div className="dynasty-promo-matchup">
                  <DynastyPortrait
                    wrestler={wrestlerOrPlaceholder(game, model.promo.leftId, model.promo.leftName)}
                    size="lg"
                  />
                  <span>VS</span>
                  <DynastyPortrait
                    wrestler={wrestlerOrPlaceholder(game, model.promo.rightId, model.promo.rightName)}
                    size="lg"
                  />
                </div>
            ...
            <article className="panel show-card-panel">
              ...
              <div className="action-row">
                {model.secondaryActions.map((action) => (
                  <button key={action.label} type="button" onClick={() => onNavigateStub(action.screen)}>
                    {action.label}
                  </button>
                ))}
                <button className="primary-action" type="button" onClick={() => onNavigateStub(model.primaryAction.screen)}>
        ...
        <aside className="dashboard-column right-column">
              ...
              model.rivalries.map((rivalry) => (
                <div className="rivalry-row" key={rivalry.id}>
                  <div className="rivalry-matchup">
                    <DynastyPortrait
                      wrestler={wrestlerOrPlaceholder(game, rivalry.leftId, rivalry.leftName)}
                      size="sm"
                    />
                    <strong>
                    ...
                    <DynastyPortrait
                      wrestler={wrestlerOrPlaceholder(game, rivalry.rightId, rivalry.rightName)}
                      size="sm"
                    />
                  </div>
          ...
          <article className="panel draft-panel">
            ...
            <button className="gold-action" type="button" onClick={() => onNavigateStub("market")}>
